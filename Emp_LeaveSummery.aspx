<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMasterPage.master" AutoEventWireup="true" CodeFile="Emp_LeaveSummery.aspx.cs" Inherits="Emp_LeaveSummery" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetDefalutLeave(Emp, MonthNo,Type) {
            ...
            $.ajax({
                url: 'WebServerFile/Employee_MasterService.asmx/GetEmployeeLeaveSummery',
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
       ...
       var MonthNo = $("#MonthDrop option:selected").val();
         ...
         function EmployeeFunWorking(id) {
            ...
            var Status = $("  " + a + " option:selected").val().trim();
                ...
                // 
                 $.ajax({
                     url: 'WebServerFile/Employee_MasterService.asmx/ApproveLevae',
                     type: 'POST',
                     data: formData,
                     cache: false,
                     contentType: false,
    ...
    <div class="card flex-fill">
        <div class="card-header">
            ...
            <div class="input-group input-group-sm" style="width: 250px; float: right;">
                ...
                <%-- &nbsp;
               &nbsp;--%>
                <select id="dd" class="form-select ms-3"  onchange="GetDetailsLeaveType()">
