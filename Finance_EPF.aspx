<%@ Page Title="" Language="C#" MasterPageFile="~/Finance_MasterPage.master" AutoEventWireup="true" CodeFile="Finance_EPF.aspx.cs" Inherits="Finance_EPF" %>
                 ...
                 success: function (data) {
                     if (data[0].response == "Fail") {
                         ...
                         for (var i = 0; i < data.length; i++) {
                             ...
                             jQuery('<tr> <td>' + j + '</td><td>' + data[i].EmpCode + '</td><td>' + data[i].EmpName + '</td> <td>' + MonthName + "-" + YearNo + '</td> <td>' + data[i].EPF_E + '</td> <td>' + data[i].EPF_ER + '</td>  <td>' + data[i].Total + '</td> '
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card flex-fill" id="MainDiv">
        <div class="card-header">
            <h5 class="card-title mb-0" style="display: block; width: 240px; float: left;">PF Results</h5>
            
            <div class="input-group input-group-sm ms-2" style="width: 150px; float: left;">
        ...
        <table id="BanlSlipTable" class="table table-striped my-0">
            <thead>
                <tr>
                    ...
                    <th class="d-none d-xl-table-cell">PF-E <samp>Employee </samp></th>
                    <th class="d-none d-xl-table-cell">PF-ER <samp>Employer</samp></th>
