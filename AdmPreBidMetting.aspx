<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdmPreBidMetting.aspx.cs" Inherits="AdmPreBidMetting" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#addItemp").click(function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "AdmPreBidMetting.aspx/SaveReqSlipItemp",
