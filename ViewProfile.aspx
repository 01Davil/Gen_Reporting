<%@ Page Title="" Language="C#" MasterPageFile="~/MasterGen.master" AutoEventWireup="true" CodeFile="ViewProfile.aspx.cs" Inherits="ViewProfile" %>
        ...
        */
        function GetEmployeeDetails(Count, Email) {
            ...
            var formData = new FormData();
                ...
                jQuery.ajax({
                    url: 'WebServerFile/WebService.asmx/GetEmployeeAllRecord',
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
        ...
        function GetEmployeeDetailsAll(Sno) {
            window.open("EmployeeProfile.aspx?Sno=" + Sno);
        }
        //
        function fun(d) {
            Count = d;
