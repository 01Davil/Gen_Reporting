<%@ Page Title="" Language="C#" MasterPageFile="~/MasterGen.master" AutoEventWireup="true" CodeFile="WFHReport.aspx.cs" Inherits="WFHReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetEmployeeLeave(YearNo, MonthNo, Email) {
            ...
            $.ajax({
                url: 'WebServerFile/WebService.asmx/GetWFHReport',
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
            ...
            $(".loaderbg").hide();
                        ...
                        var j = 1;
                        jQuery('<thead><tr><th>S.No.</th><th class="d-none d-xl-table-cell">Employee Name</th><th class="d-none d-xl-table-cell">From</th><th class="d-none d-xl-table-cell">To</th><th class="d-none d-md-table-cell">Purpose</th>   <th class="d-none d-md-table-cell">Leave Status</th>   <th class="d-none d-md-table-cell">Approved / Reject</th><th class="d-none d-md-table-cell">Available</th><th class="d-none d-md-table-cell">Used</th></tr></thead>').appendTo("#BanlSlipTable");
                        for (var i = 0; i < data.length; i++) {

                            if (data[i].LeaveStatus == "Approved") {

                                jQuery('<tbody> <tr> <td class="d-none d-xl-table-cell">' + j + '</td> <td class="d-none d-xl-table-cell">' + data[i].EmpName + '</td> <td class="d-none d-xl-table-cell">' + data[i].FDate + '</td> <td class="d-none d-xl-table-cell">' + data[i].TDate + '</td> <td class="d-none d-xl-table-cell">' + data[i].Purpose + '</td> <td class="d-none d-xl-table-cell"> <span class="badge bg-success">' + data[i].LeaveStatus + '</span> </td>  <td class="d-none d-xl-table-cell">' + data[i].ApprovedName + '</td>  <td class="d-none d-xl-table-cell">' + data[i].Leave + '</td>  <td class="d-none d-xl-table-cell">' + data[i].UsedLeave + '</td>     </tr> </tbody>').appendTo("#BanlSlipTable");

                            } else if (data[i].LeaveStatus == "Reject") {
