...
public partial class AdmPreBidMetting : System.Web.UI.Page
{
    ...
    //[WebMethod]
    //public static List<ItemClass> ItemDelete(string Tender_Name, int id)
    //{
    //    DataTable dt = new DataTable();
    //    DataSet ds = new DataSet();
    //    try
    ...
    //        SqlConnection con = new SqlConnection(conn);
    //        con.Open();
    //        cmd = new SqlCommand("Delete_PrebidItemp", con);
