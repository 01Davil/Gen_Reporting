<%@ Page Title="" Language="C#" MasterPageFile="~/Finance_MasterPage.master" AutoEventWireup="true" CodeFile="Finance_ApplyExpenese.aspx.cs" Inherits="Finance_ApplyExpenese" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#BtnSave").click(function (e) {
                ...
                if (Amount.length == 0 || Amount == ' ' || Purpose.length == 0 || Purpose == '') {
                    Swal.fire('All Required Files');
                } else {
                    if (file == 0) {
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="file" id="SlipFile" class="form-control" placeholder="">
                        </div>
                    </div>
