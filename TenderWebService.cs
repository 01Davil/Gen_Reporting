...
/// </summary>http://localhost:50193/App_Code/TenderWebService.cs
...
public class TenderWebService : System.Web.Services.WebService
{
    ...
    public void SaveTender()
    {
        ...
        string T_PreBidMeetingTime = HttpContext.Current.Request.Form["T_PreBidMeetingTime"];
        string T_PreBidMeetingV = HttpContext.Current.Request.Form["T_PreBidMeetingV"];
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@T_PreBidMeetingTime", T_PreBidMeetingTime);
            cmd.Parameters.AddWithValue("@T_PreBidMeetingV", T_PreBidMeetingV);
    ...
    public void Tenderuploadfile()
    {
        ...
        UName = "http://122.160.172.187/genreporting/UploadFile/TenderUploadFile/" + UName;
    ...
    public void GetTenderList()
    {
        ...
        try
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Select id,Tender_Name,Company_Name,convert(varchar(20),T_Publication_Date,103) as T_Publication_Date ,convert(varchar(20),T_SubmittingDate,103)as T_SubmittingDate,convert(varchar(20),OpeningDate,103)as OpeningDate,convert(varchar(20),T_PreBidMeetingDate,103) as T_PreBidMeetingDate,convert(varchar(20),T_PreBidMeetingTime,103) as T_PreBidMeetingTime,T_PreBidMeetingV,convert(varchar,Extended_SubmissionDate,105)as Extended_SubmissionDate,(case when status='PENDING' then 'PENDING' when status ='WIN' then 'WIN' else 'LOST' end) status,DbDateTime from Master_TenderDetails where Status = 0", con);
    ...
    //prebid view details in admin
    [WebMethod]
    public void GetprebbidList()
    {
        DataTable dt;
        SqlConnection con = new SqlConnection(conn);
        String resultJSON = "";
        ...
        try
        {
            ...
            string s = HttpContext.Current.Request.Form["Sno"];
            con.Open();
            SqlCommand cmd = new SqlCommand("Select id,Tender_Name ,Company_Name,AttenderName,Discussion,OurQuery,Status,T_MeetingFile,convert(varchar(20),MeetingDate,103)as MeetingDate from Tender_PreBidMeetingDetails", con);
            //cmd.Parameters.Add("@Sno", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Sno"];
            //cmd.Parameters.Add("@Type", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Type"];
            //cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
    ...
    public void GetTenderEdit()
    {
        ...
        try
        {
            ...
            string s = HttpContext.Current.Request.Form["id"];
            con.Open();
            SqlCommand cmd = new SqlCommand("Tender_GetEdit", con);
            cmd.Parameters.Add("@id", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["id"];
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
    ...
    public void SavePreBidMeeting()
    {
        ...
        try
        {
            ...
            int fileCount = Directory.GetFiles(Gpath, "*.*", SearchOption.AllDirectories).Length;
            HttpPostedFile postedFile = HttpContext.Current.Request.Files[0];
            string UName2 = Tender_Name + fileCount + Path.GetExtension(postedFile.FileName);
            string MPath2 = Gpath + UName2;
            postedFile.SaveAs(MPath2);
            UName2 = "http://122.160.172.187/genreporting/UploadFile/TenderMeetingFile/" + UName2;
            ...
            cmd.Parameters.AddWithValue("@T_MeetingFile", UName2);
            cmd.Parameters.Add("@Ret", SqlDbType.Char, 100);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters["@Ret"].Direction = ParameterDirection.Output;
            cmd.ExecuteNonQuery();
    ...
    public void SaveOtherCPreBidMeeting()
    {
        ...
        string MPath = Gpath + UName;
       // postedFile.SaveAs(MPath);
        UName = "http://122.160.172.187/genreporting/UploadFile/TenderMeetingFile/" + UName;
    ...
    public void GetWinTenderList()
    {
        ...
        try
        {
            ...
            string s = HttpContext.Current.Request.Form["Sno"];
            con.Open();
            SqlCommand cmd = new SqlCommand("select Id,Tender_Name,Tender_Item,T_Quantity,Price,convert(varchar(20),Delivery_Date,103) as Delivery_Date,Delivery_Location,L1_Our_Company,L1_Bid_Price,L2_Second_Com,L2_Bid_Price,L3_Third_Comany,L3_Bid_Price from Win_TenderDetails", con);
            //cmd.Parameters.Add("@Sno", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Sno"];
            //cmd.Parameters.Add("@Type", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Type"];
            //cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
    ...
    public void GetLostTenderList()
    {
        ...
        try
        {
            ...
            string s = HttpContext.Current.Request.Form["Sno"];
            con.Open();
            SqlCommand cmd = new SqlCommand("select Id,Tender_Name,Tender_Item,T_Quantity,Price,convert(varchar(20),Delivery_Date,103) as Delivery_Date,L1_Our_Company,L1_Bid_Price,L2_Second_Com,L2_Bid_Price,L3_Third_Comany,L3_Bid_Price,OurPosition,Our_Bid_Price from Lost_TenderDetails", con);
            //cmd.Parameters.Add("@Sno", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Sno"];
            //cmd.Parameters.Add("@Type", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Type"];
            //cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
    ...
    //multiple for prebid view
    [WebMethod]
    public void ViewpreBidmulti()
    {
        DataTable dt;
        SqlConnection con = new SqlConnection(conn);
        String resultJSON = "";
        ...
        try
        {
            ...
            string s = HttpContext.Current.Request.Form["id"];           
            con.Open();
            SqlCommand cmd = new SqlCommand("GetPrebidmultiple", con);
            cmd.Parameters.Add("@MasterKey", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["id"];         
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
    ...
    public void CheckTender()
    {
        ...
        try
        {
            ...
            Context.Response.ContentType = "application/json";
            con.Open();
            SqlCommand cmd = new SqlCommand("CheckTenderDoc", con);
            cmd.Parameters.Add("@Tender_Name", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Name"];
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
    ...
    {
        string Result = "";
        string MasterId = HttpContext.Current.Request.Form["MasterId"];
        string Tender_Name = HttpContext.Current.Request.Form["Tender_Name"];
        string Company_Name = HttpContext.Current.Request.Form["Company_Name"];
        string T_Publication_Date = HttpContext.Current.Request.Form["T_Publication_Date"];
        string T_PreBidMeetingDate = HttpContext.Current.Request.Form["T_PreBidMeetingDate"];
        ...
        try
        {
            ...
            SqlConnection con = new SqlConnection(conn);
            con.Open();
            cmd = new SqlCommand("GetUpdateTenderData", con);
