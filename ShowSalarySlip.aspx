<%@ Page Title="" Language="C#" MasterPageFile="~/MasterGen.master" AutoEventWireup="true" CodeFile="ShowSalarySlip.aspx.cs" Inherits="ShowSalarySlip" %>
            ...
            $.ajax({
                ...
                success: function (r) {
                    ...
                    if (xmlDoc == 0 || xmlDoc == '0') {
                        ...
                        window.open("ViewSalarySlip.aspx?Monthno=" + MonthNo + "&YearNo=" + YearNo);
                    }
                }
            });
           // 
