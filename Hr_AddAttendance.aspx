<%@ Page Title="" Language="C#" MasterPageFile="~/HRMasterPage.master" AutoEventWireup="true" CodeFile="Hr_AddAttendance.aspx.cs" Inherits="Hr_AddAttendance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#BtnSave").click(function (e) {
                ...
                if (Name == ' ' || Date == "" || Purpose == "") {
                    ...
                    $.ajax({
                        url: 'WebServerFile/Hr_MasterWebService.asmx/SaveAttendance',
                        type: 'POST',
                        data: formData,
                        cache: false,
                        contentType: false,
        ...
        function GetAttendacne(YearNo, MonthNo, EmpName) {
            ...
            formData.append("Type", "Manuall");
            $.ajax({
                url: 'WebServerFile/Hr_MasterWebService.asmx/GetAttendance',
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
            ...
            <div class="col-12 col-lg-12 d-flex">
                <div class="card flex-fill w-100">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Add Attendance</h5>
                    </div>
                    <div class="card-body">
