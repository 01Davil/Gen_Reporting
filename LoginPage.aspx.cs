...
public partial class LoginPage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["LoginType"] = "NA";
        Session.Timeout = 324000;
    }
    [WebMethod]
    public static string SetValuse(string LoginSno,string LoginIDMax,string LoginEmpCode,string LoginName,string LoginEmail, string LoginImage, string LoginRoleId,string LoginType)
    {
    ...
    public void SendEmailBg(string SendEmail, string Sno)
    {
        ...
        msg.Body = "<body><head> "
           ...
           + " <br></br><a href='http://122.160.172.187/genreporting/ForGetPassword.aspx?Sno=" + Sno + " 'style = 'background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;' > Reset  Password </ a > "
