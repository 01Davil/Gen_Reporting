<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMasterPage.master" AutoEventWireup="true" CodeFile="PreBidMeeting.aspx.cs" Inherits="PreBidMeeting" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#addItemp").click(function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "PreBidMeeting.aspx/SaveReqSlipItemp",
