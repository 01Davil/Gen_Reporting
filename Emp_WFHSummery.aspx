<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeMasterPage.master" AutoEventWireup="true" CodeFile="Emp_WFHSummery.aspx.cs" Inherits="Emp_WFHSummery" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GetDefalutLeave(Emp, MonthNo) {
            ...
            $.ajax({
                url: 'WebServerFile/Employee_MasterService.asmx/GetAppledWFHList',
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
        ...
        function EmployeeFunWorking(id) {
            ...
            if (Status == 0 || status == '0') {
                ...
                formData.append("Sno", "<%= Session["LoginSno"].ToString()%>");
                 ...
                 $.ajax({
                     url: 'WebServerFile/Employee_MasterService.asmx/UpdateWFHStatuss',
                     type: 'POST',
                     data: formData,
                     cache: false,
                     contentType: false,
