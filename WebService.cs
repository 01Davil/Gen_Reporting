...
public class WebService : System.Web.Services.WebService
{
    ...
    //kanika empcode get hr fnf
    [WebMethod]
    public void Get_ECodeList()
    {
        DataTable dt;
        SqlConnection con = new SqlConnection(conn);
        String resultJSON = "";
        ...
        try
        {
            ...
            Context.Response.ContentType = "application/json";
            con.Open();
            SqlCommand cmd = new SqlCommand("Get_EmployeCodeList", con);
            cmd.Parameters.Add("@Name", SqlDbType.VarChar).Value = HttpContext.Current.Request.Form["Num"];
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
    ...
    {
        string Result = "";
        string MetHead = HttpContext.Current.Request.Form["Methead"];
        string Metdat = HttpContext.Current.Request.Form["Metdate"];
        string Mettim = HttpContext.Current.Request.Form["Mettime"];
        string Medep = HttpContext.Current.Request.Form["MetDepament"];
        string Me = HttpContext.Current.Request.Form["MetEmp"];
        string Mem = HttpContext.Current.Request.Form["Metmode"];
        string Medesc = HttpContext.Current.Request.Form["MetDetails"];       
        // 
        try
        {
            SqlCommand cmd = new SqlCommand();
            SqlConnection con = new SqlConnection(conn);
            con.Open();
            cmd = new SqlCommand("AddMeeting", con);
            cmd.Parameters.AddWithValue("@Sno", HttpContext.Current.Request.Form["Sno"]);
            cmd.Parameters.AddWithValue("@Methead", MetHead);
            cmd.Parameters.AddWithValue("@Metdate", Metdat);
            cmd.Parameters.AddWithValue("@Mettime", Mettim);
            cmd.Parameters.AddWithValue("@MetDepament", Medep);
            cmd.Parameters.AddWithValue("@MetEmp", Me);
            cmd.Parameters.AddWithValue("@Metmode", Mem);
            cmd.Parameters.AddWithValue("@MetDetails", Medesc);
    ...
    public void ShowMeet()
    {
        ...
        try
        {
            ...
            Context.Response.ContentType = "application/json";
            con.Open();
            SqlCommand cmd = new SqlCommand("ShowMeeting", con);
            cmd.Parameters.AddWithValue("@Metdate", HttpContext.Current.Request.Form["Metdate"]);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
    ...
    public void DeleteMeeting()
    {
        ...
        try
        {
            ...
            SqlConnection con = new SqlConnection(conn);
            con.Open();
            cmd = new SqlCommand("delete from MEETINGS_DETAIL where id = '" + HttpContext.Current.Request.Form["id"] + "'", con);
            cmd.ExecuteNonQuery();
            con.Close();
            Result = "Save";
        }
    ...
    public void UpdateMeeting1()
    {
        ...
        try
        {
            ...
            Context.Response.ContentType = "application/json";
            con.Open();
            SqlCommand cmd = new SqlCommand("UpdateMetting", con);
            cmd.Parameters.AddWithValue("@id", HttpContext.Current.Request.Form["id"]);
            cmd.Parameters.AddWithValue("@Methead", HttpContext.Current.Request.Form["Methead"]);
            cmd.Parameters.AddWithValue("@Metdate",  HttpContext.Current.Request.Form["Metdate"]);
            cmd.Parameters.AddWithValue("@Mettime",  HttpContext.Current.Request.Form["Mettime"]);
            cmd.Parameters.AddWithValue("@MetDepament",  HttpContext.Current.Request.Form["MetDepament"]);
            cmd.Parameters.AddWithValue("@MetEmp",  HttpContext.Current.Request.Form["MetEmp"]);
            cmd.Parameters.AddWithValue("@Metmode",  HttpContext.Current.Request.Form["Metmode"]);
            cmd.Parameters.AddWithValue("@MetDetails",  HttpContext.Current.Request.Form["MetDetails"]);  
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            da.Fill(ds);
